...
Command: npx gltfjsx@6.5.2 ./models/d007.glb --types --exportdefault --output=./gltf/d007.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d007: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d007(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
