...
Command: npx gltfjsx@6.5.2 ./models/d069.glb --types --exportdefault --output=./gltf/d069.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d069: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d069(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
