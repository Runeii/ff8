...
Command: npx gltfjsx@6.5.2 ./models/d055.glb --types --exportdefault --output=./gltf/d055.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d055: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d055(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
