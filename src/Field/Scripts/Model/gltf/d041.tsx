...
Command: npx gltfjsx@6.5.2 ./models/d041.glb --types --exportdefault --output=./gltf/d041.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d041: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d041(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
