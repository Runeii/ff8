...
Command: npx gltfjsx@6.5.2 ./models/d052.glb --types --exportdefault --output=./gltf/d052.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d052: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d052(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
