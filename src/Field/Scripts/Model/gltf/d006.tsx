...
Command: npx gltfjsx@6.5.2 ./models/d006.glb --types --exportdefault --output=./gltf/d006.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d006: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d006(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
