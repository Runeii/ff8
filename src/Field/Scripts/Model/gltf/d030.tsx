...
Command: npx gltfjsx@6.5.2 ./models/d030.glb --types --exportdefault --output=./gltf/d030.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d030: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d030(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
