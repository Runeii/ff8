...
Command: npx gltfjsx@6.5.2 ./models/d026.glb --types --exportdefault --output=./gltf/d026.tsx 
*/
...
export default React.forwardRef(function d026(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
