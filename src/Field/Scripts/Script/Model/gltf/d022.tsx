...
Command: npx gltfjsx@6.5.3 ./models/d022.gltf --types --keepgroups --exportdefault --output=../gltf/d022.tsx 
*/
...
type ActionName = 'd022_action_0' | 'd022_action_1' | 'd022_action_2' | 'd022_action_3'
 ...
 useImperativeHandle(ref, () => ({ animations: formattedAnimations, group, nodes, materials }));
   return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="d022_armature" position={[0, 0, 0.863]}>
