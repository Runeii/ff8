...
Command: npx gltfjsx@6.5.2 ./models/d058.glb --types --exportdefault --output=./gltf/d058.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d058: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d058(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
