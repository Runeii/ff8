...
Command: npx gltfjsx@6.5.2 ./models/d047.glb --types --exportdefault --output=./gltf/d047.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d047: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d047(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
