...
Command: npx gltfjsx@6.5.2 ./models/d060.glb --types --exportdefault --output=./gltf/d060.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d060: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d060(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
