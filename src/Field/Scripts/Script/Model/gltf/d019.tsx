...
Command: npx gltfjsx@6.5.2 ./models/d019.glb --types --exportdefault --output=./gltf/d019.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d019: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d019(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
