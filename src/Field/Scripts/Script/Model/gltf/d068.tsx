...
Command: npx gltfjsx@6.5.2 ./models/d068.glb --types --exportdefault --output=./gltf/d068.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d068: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d068(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
