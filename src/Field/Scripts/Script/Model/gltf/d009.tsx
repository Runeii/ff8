...
Command: npx gltfjsx@6.5.2 ./models/d009.glb --types --exportdefault --output=./gltf/d009.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d009: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d009(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
