...
Command: npx gltfjsx@6.5.2 ./models/d024.glb --types --exportdefault --output=./gltf/d024.tsx 
*/
...
type GLTFResult = GLTF & {
  ...
  materials: {
    d024: THREE.MeshPhysicalMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d024(props: JSX.IntrinsicElements['group'], ref: React.Ref<{ actions: any }>) {
